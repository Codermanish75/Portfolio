...
const contacts = [
  ...
  { label: 'LeetCode C++', value: 'codermanish_75. C++· 150+', href: 'https://leetcode.com/codermanish_75', icon: '⚡', accent: '#ffa116' },
  { label: 'GFG C++', value: 'officialmau8 · 300+ C++', href: 'https://www.geeksforgeeks.org/profile/officialmau8?tab=activity', icon: '🌿', accent: '#2f8d46' },
  { label: 'LeetCode Python', value: 'codermanish_75 Python· 150+', href: 'https://leetcode.com/u/manish_7518/', icon: '⚡', accent: '#ffa116' },
  { label: 'GFG Python', value: 'officialmau8 · 300+ Python', href: 'https://www.geeksforgeeks.org/profile/manishsiy5ep?tab=activity', icon: '🌿', accent: '#41b63d' }
]
